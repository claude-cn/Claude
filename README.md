# Claude 国内最新使用指南~ （支持 Claude 3.7，稳定好用~）【2025年3月更新】

> 更新日期：**2025-03-14**          

在国内轻松使用 [**Claude 中文版**](https://chat.yixiaai.com) 教程，**无需翻墙**，**支持 Claude 3.7、Claude 3.5 及中文版功能**   

本指南提供全面的 **Claude 国内使用指南**，包括国内可用的 [**Claude 网页版**](https://chat.yixiaai.com)、[**Claude 国内入口**](https://chat.yixiaai.com)、[**Claude 官网平替**](https://chat.yixiaai.com)和详细使用教程，帮助您快速使用上 Claude~
...
- [chat.lanjing.ai](https://chat.lanjing.ai/) - **Claude 镜像网站**，支持 Claude-3.7、Claude-3.5、GPT-o1、o3及Groq-3，AI文件、AI PPT、AI助手、AI插件功能、思维导图~
